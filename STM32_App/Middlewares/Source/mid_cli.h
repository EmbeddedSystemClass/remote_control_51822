/*
 * CLI V1.0.4 (C) 2014 Real Time Engineers ltd. All rights reserved.
 *
 * This file is part of the CLI distribution.  The CLI license
 * terms are different to the FreeRTOS license terms.
 *
 * CLI uses a dual license model that allows the software to be used
 * under a standard GPL open source license, or a commercial license.  The
 * standard GPL license (unlike the modified GPL license under which FreeRTOS
 * itself is distributed) requires that all software statically linked with
 * CLI is also distributed under the same GPL V2 license terms.
 * Details of both license options follow:
 *
 * - Open source licensing -
 * CLI is a free download and may be used, modified, evaluated and
 ...
 * license before incorporating CLI into proprietary software for
 ...
 * changed.
 *
 * CLI is distributed in the hope that it will be useful.  You cannot
 * use CLI unless you agree that you use the software 'as is'.
 * CLI is provided WITHOUT ANY WARRANTY; without even the implied
 ...
 * by pcWriteBuffer.
 *
 * MidCLI_ProcessCommand should be called repeatedly until it returns pdFALSE.
 *
 * pcCmdIntProcessCommand is not reentrant.  It must not be called from more
 * than one task - or at least - by more than one task at a time.
 */
BaseType_t MidCLI_ProcessCommand( const char * const pcCommandInput, char * pcWriteBuffer, size_t xWriteBufferLen  );
 ...
 *
 * MidCLI_GetOutputBuffer() returns the address of the output buffer.char
 */
