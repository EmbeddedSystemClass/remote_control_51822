...
#ifndef __MX25L12835F_H
#define __MX25L12835F_H
...
extern "C"
  {
    ...
    /** @defgroup MX25L12835F_Exported_Constants
     * @{
     */

    /**
     * @brief  MX25L12835F Configuration
     */
#define N25Q128A_FLASH_SIZE                     0x1000000   /* 128 MBits => 16MBytes */
#define N25Q128A_BLOCK_SIZE                     0x8000      /* 32K Bytes */
#define N25Q128A_SECTOR_SIZE                    0x1000      /* 4K Bytes */
#define N25Q128A_SUBSECTOR_SIZE                 0x1000    /* 4096 subsectors of 4kBytes */
#define N25Q128A_PAGE_SIZE                      0x100     /*  256 Bytes */

#define  N25Q128A_ADD_FOR_FW_MCU_SIZE           0x00000
#define  N25Q128A_SEC_FOR_FW_MCU_SIZE           0x40000 /*512Kb，占用128个SEC  用于固件信息，256 用于STM32_MCU,256 用于NRF51_MCU*/
#define  N25Q128A_ADD_FOR_FW_BLE_SIZE	        0x40000
#define  N25Q128A_SEC_FOR_FW_BLE_SIZE	        0x40000
#define  N25Q128A_FAFTS_START_ADD               0x80000
#define  N25Q128A_FAFTS_SEC_SIZE        	    0xF80/*文件系统可用SEC的数量，4096-128*/
...
#define N25Q128A_FSR_READY                   ((uint8_t)0x80)    /*!< Ready or command in progress */
    /*Flag Status Reg1*/
#define W25Q128F_STATUS1_BUSY		 ((uint8_t)0x01)  	/*Write/Ease In Progress*/
#define W25Q128F_STATUS1_WEL		 ((uint8_t)0x02)  	/*Write Enable*/
#define W25Q128F_STATUS1_BP0		 ((uint8_t)0x04)  	/*Block Protect Bits0*/
#define W25Q128F_STATUS1_BP1		 ((uint8_t)0x08) 	/*Block Protect Bits1*/
#define W25Q128F_STATUS1_BP2		 ((uint8_t)0x10) 	/*Block Protect Bits2*/
#define W25Q128F_STATUS1_TB	         ((uint8_t)0x20) 	/*Top/Bottom Protect Bit*/
#define W25Q128F_STATUS1_SEC		 ((uint8_t)0x40) 	/*Sector Protect Bit*/
#define W25Q128F_STATUS1_SRP0		 ((uint8_t)0x80) 	/*Sector Protect Bit*/
    /**
     * @}
     */
